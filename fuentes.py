...
cabeceras =['url','Nombre', 'Otros_nombres', 'Pedania', 'Municipio', 'Provincia', 'CoordX','CoordY', 'Cuenca', 'Subcuenca', 'Rio', 'Masa_agua', 'ENP', 'Lugar', 'Naturaleza','Tipo', 'Descripcion', 'Instalaciones_asociadas', 'Caudal', 'Se_agota', 'Uso_agua', 'Acceso', 'Uso_publico','valoracion_acceso','Conservacion', 'Amenazas', 'Descripcion_hidrogeológica','Descripcion_arquitectonica',  'Antecedentes_historicos', 'Aspectos_culturales', ' Otra_informacion', 'Cientifico', 'Minero', 'Paisajistico', 'Otros', 'Medioambiental', 'Recreativo', 'Historico', 'Arquitectonico', 'Economico', 'Arraigo', 'Valoracion', 'Autor', 'Fecha']
with open('conocetusfuentes_04_22.csv',  'a',newline='',encoding="ISO-8859-1") as csvfile:
    ...
    for i in range(1, 13500):
        ...
        # Realizamos la peticiÃ³n a la we#b
        ...
        if status_code == 200:
            ...
            # Obtenemos todos los div y span donde estÃ¡n las entradas
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Procedencia del agua subterránea" in titulo_h4):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ((titulo_h4.find("Descripción"))!=-1):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Acceso y uso público actual" in titulo_h4):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Estado de conservación" in titulo_h4):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Descripción hidrogeológica" in titulo_h4):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Descripción arquitectónica" in titulo_h4):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Antecedentes históricos" in titulo_h4):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Aspectos culturales y etnográficos" in titulo_h4):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Otra información" in titulo_h4):
                indice_titulos = indice_titulos+1
            ...
            titulo_h4 = columna_1.findChildren(['h4'])[indice_titulos]
            if ("Valoración general" in titulo_h4):
                indice_titulos = indice_titulos+1
